...
custom_imports = dict(imports=["prithvi"])
num_frames = 3
img_size = 224
num_workers = 2
...
pretrained_weights_path = "./prithvi/models/Prithvi_100M.pt"
num_layers = 6
patch_size = 16
embed_dim = 768
num_heads = 8
...
model = dict(
    ...
    backbone=dict(
        ...
        in_chans=len(bands),
        embed_dim=embed_dim,
        depth=12, # weirdly 12 in the Pritvi_100M.pth but was set to 6 in the original code
        num_heads=num_heads,
        mlp_ratio=4.0,
        norm_pix_loss=False,
    ),
